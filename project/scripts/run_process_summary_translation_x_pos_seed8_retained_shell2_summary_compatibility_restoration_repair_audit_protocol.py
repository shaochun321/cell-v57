...
def main() -> None:
    ap = argparse.ArgumentParser(description='Run translation_x_pos seed8 retained-shell2 summary compatibility restoration repair audit.')
    ...
    ap.add_argument('--seed8-round48-summary', required=True)
    ...
    audit = build_translation_x_pos_seed8_retained_shell2_summary_compatibility_restoration_repair_audit(
        ...
        seed8_round48_summary_path=args.seed8_round48_summary,
    )

    outdir = Path(args.outdir)
    outdir.mkdir(parents=True, exist_ok=True)
    out = outdir / 'process_summary_translation_x_pos_seed8_retained_shell2_summary_compatibility_restoration_repair_audit.json'
