...
def build_translation_x_pos_seed8_shell2_second_active_window_retention_restoration_repair_audit(
    *,
    ...
    evidence = {
        'baseline_seed8_second_active_shell2_static_like': bool(baseline_shell2_second) and baseline_shell2_second.get('dominant_mode') == 'static_like',
        'repaired_seed8_second_active_shell2_translation_like': bool(repaired_shell2_second) and repaired_shell2_second.get('dominant_mode') == 'translation_like',
        'repaired_seed8_second_active_shell2_positive_sign': bool(repaired_shell2_second) and float(repaired_shell2_second.get('direction_sign', 0.0)) > 0.0,
        ...
        'repaired_seed8_shell2_translation_carrier_count_exceeds_baseline': int(seed8_repaired_counts['per_shell'].get('2', 0)) > int(seed8_base_counts['per_shell'].get('2', 0)),
    ...
    return {
        'suite': 'translation_x_pos_seed8_shell2_second_active_window_retention_restoration_repair_audit_r1',
        ...
        'evidence': evidence,
        'inferred_outcome': 'translation_x_pos_seed8_shell2_second_active_window_retention_restoration_repair_success' if contracts_passed else 'undetermined',
        'residual_issue': 'retained_shell2_carrier_summary_compatibility_still_shallow',
    }
