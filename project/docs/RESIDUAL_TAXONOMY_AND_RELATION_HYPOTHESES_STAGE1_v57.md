...
## v55 residual update
ATLAS-R7 should be treated as a repeated guard-overreach family, not as generic sign failure. ATLAS-R8 should be treated as an isolated gate/basis spill until repetition or a dedicated basis audit justifies stronger claims.


## v57 residual note
`ATLAS-R7` should now be treated as a recoverable separator-suppression overreach family rather than an open phase-2 mystery. `ATLAS-R8` remains the only open phase-2 residual and should not be merged into `R7` simply because both appeared on the same target panel.
