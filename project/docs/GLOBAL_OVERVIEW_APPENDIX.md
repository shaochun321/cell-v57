...
## v57 note
The phase-2 positive-guard raw validation strengthens the overview-first reading only in a narrow compensator sense: a repeated high-curl rotation subset was recoverable by restoring separator authority in a regime outside seen positive mid-sharp support. This is not evidence that controlled safeguards are no longer needed.
