...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description='Run the first N288 harder unseen-nuisance panel for the fixed two-guard overview-first farther-scale stack.')
    p.add_argument('--outdir', type=str, default='outputs/stage1_global_overview_farther_scale_n288_harder_nuisance_panel_raw')
    p.add_argument('--num-cells', type=int, nargs='+', default=[64, 96, 128, 288])
