...
def build_translation_x_pos_seed8_active_x_carrier_floor_signal_microblend_repair_audit(
    *,
    ...
    evidence = {
        "seed8_translation_x_pos_gap_reduced_vs_round45": current_gap < previous_gap,
        "seed8_translation_x_pos_active_amplitude_improved_vs_round45": txp8["active_mean_polarity_projection"] > float(previous_round.get("seed8", {}).get("translation_x_pos", {}).get("active_mean_polarity_projection", 0.0)),
    ...
    return {
        "suite": "translation_x_pos_seed8_active_x_carrier_floor_signal_microblend_repair_audit_r1",
        ...
        "seed8": seed8,
        "evidence": evidence,
        "inferred_outcome": "translation_x_pos_seed8_active_x_carrier_floor_signal_microblend_repair_success" if contracts_passed else "undetermined",
