...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument('--smoothing-json', default=str(ROOT / 'outputs/process_summary_translation_carrier_smoothing_sensitivity_audit_r1/process_summary_translation_carrier_smoothing_sensitivity_audit.json'))
...
def run_protocol(args: argparse.Namespace) -> dict[str, str | dict]:
    ...
    payload = audit_translation_polarity_resolution_floor_files(carrier_path=args.carrier_json, smoothing_path=args.smoothing_json)
    out_path = outdir / 'process_summary_translation_polarity_resolution_floor_audit.json'
