...
def main() -> None:
    ap = argparse.ArgumentParser(description='Run translation_x family strongest-pair translation-mode restoration repair audit.')
    ...
    (outdir / 'process_summary_translation_x_family_strongest_pair_translation_mode_restoration_repair_audit.json').write_text(
