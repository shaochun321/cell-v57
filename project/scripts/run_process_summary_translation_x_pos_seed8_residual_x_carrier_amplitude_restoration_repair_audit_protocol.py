...
def main() -> None:
    ap = argparse.ArgumentParser(description='Run translation_x_pos seed8 residual x-carrier amplitude restoration repair audit.')
    ...
    out = outdir / 'process_summary_translation_x_pos_seed8_residual_x_carrier_amplitude_restoration_repair_audit.json'
