...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description='Run a harder unseen-nuisance cross-scale panel for overview-first OOD validation.')
    p.add_argument('--outdir', type=str, default='outputs/stage1_global_overview_harder_nuisance_panel_raw')
