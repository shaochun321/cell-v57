...
def main() -> None:
    ap = argparse.ArgumentParser(description='Run translation_x_pos seed8 inner-shell x-carrier amplitude source redesign repair audit.')
    ...
    out = outdir / 'process_summary_translation_x_pos_seed8_inner_shell_x_carrier_amplitude_source_redesign_repair_audit.json'
