...
def main() -> None:
    ap = argparse.ArgumentParser(description="Run translation_x_pos residual polarity sign restoration repair audit.")
    ...
    (outdir / "process_summary_translation_x_pos_residual_polarity_sign_restoration_repair_audit.json").write_text(
