...
def main() -> None:
    ap = argparse.ArgumentParser(description="Run translation_x_pos seed8 carrier floor cleanup repair audit.")
    ...
    (outdir / "process_summary_translation_x_pos_seed8_carrier_floor_cleanup_repair_audit.json").write_text(
