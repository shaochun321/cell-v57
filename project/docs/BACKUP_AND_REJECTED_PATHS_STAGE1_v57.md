...
## v57 caution
The v57 raw validation must not be narrated as farther-scale closure. It localizes and repairs `R7`, but the phase-2 panel is still not fully clean while `R8` remains unresolved.
