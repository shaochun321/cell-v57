...
def run_protocol(args: argparse.Namespace) -> dict[str, str | dict]:
    ...
    payload = audit_translation_mirrored_asymmetry_files(seed_profiles_path=args.seed_profiles, decomposition_path=args.decomposition_json)
    out_path = outdir / 'process_summary_translation_mirrored_asymmetry_audit.json'
