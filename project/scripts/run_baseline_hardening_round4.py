...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description='Run baseline hardening round 4 protocols.')
    ...
    p.add_argument('--outdir', type=str, default='outputs/baseline_hardening_round4')
    return p.parse_args()
