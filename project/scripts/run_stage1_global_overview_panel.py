...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description='Run a compact raw panel for the global overview prototype.')
    p.add_argument('--outdir', type=str, default='outputs/stage1_global_overview_panel_raw')
...
def main() -> None:
    ...
    manifest: dict[str, object] = {
        'protocol': 'stage1_global_overview_panel',
    ...
    (outdir / 'stage1_global_overview_manifest.json').write_text(json.dumps(manifest, ensure_ascii=False, indent=2))
    print(f'[OK] global overview panel written to {outdir}')
