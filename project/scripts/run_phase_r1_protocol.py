...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description='Run Phase R.1 focused audit for rotation/layered-track repair.')
    ...
    p.add_argument('--outdir', type=str, default='outputs/phase_r1_sample')
    return p.parse_args()
...
def main() -> None:
    ...
    soft_cells = max(60, args.num_cells - 10)
    soft_translation = 0.85 * args.translation_accel
    soft_rotation = 0.85 * args.rotation_alpha
    ...
    report_path = outdir / 'phase_r1_protocol_report.json'
    ...
    print(f'Phase R.1 审计: {audit_path}')
