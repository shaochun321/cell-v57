...
def run_protocol(args: argparse.Namespace) -> dict[str, str | dict]:
    ...
    payload = audit_translation_inner_outer_shell_files(repeatability_report_path=args.repeatability_report)
    out = outdir / 'process_summary_translation_inner_outer_shell_audit.json'
