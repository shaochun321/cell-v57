...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description='Run translation-only multi-scale sign panel.')
    p.add_argument('--outdir', type=str, default='outputs/stage1_translation_sign_scale_panel_raw')
...
def main() -> None:
    ...
    manifest: dict[str, object] = {
        'protocol': 'stage1_translation_sign_scale_panel',
    ...
    (outdir / 'stage1_translation_sign_scale_manifest.json').write_text(json.dumps(manifest, ensure_ascii=False, indent=2))
    print(f'[OK] translation sign scale panel written to {outdir}')
