...
def main() -> None:
    ap = argparse.ArgumentParser(description='Run translation_x_pos active polarity amplitude strengthening repair audit.')
    ...
    (outdir / 'process_summary_translation_x_pos_active_polarity_amplitude_strengthening_repair_audit.json').write_text(
