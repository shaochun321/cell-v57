...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument(
        ...
        default=str(ROOT / 'outputs/process_summary_repeatability_r1/process_summary_repeatability_audit.json'),
    )
...
def run_protocol(args: argparse.Namespace) -> dict[str, str | dict]:
    ...
    audit = audit_translation_interface_family_carriers_files(repeatability_report_path=args.repeatability_report)
    audit_path = outdir / 'process_summary_translation_interface_family_carrier_audit.json'
