...
def main() -> None:
    ...
    (outdir / "process_summary_translation_x_pos_seed8_active_x_carrier_dilution_cleanup_repair_audit_analysis.json").write_text(
    ...
    ax.set_title("Round42 residual seed8 active x-carrier dilution cleanup")
    ax.axhline(0.03, linestyle="--", linewidth=1.0)
    fig.tight_layout()
    fig.savefig(outdir / "process_summary_translation_x_pos_seed8_active_x_carrier_dilution_cleanup_repair_audit.png", dpi=160)
